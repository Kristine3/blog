...
class TshirtsControllerTest < ActionController::TestCase
  ...
  test "should create tshirt" do
    assert_difference('Tshirt.count') do
      post :create, tshirt: { color: @tshirt.color, description: @tshirt.description, neck_size: @tshirt.neck_size }
    end
  ...
  test "should update tshirt" do
    patch :update, id: @tshirt, tshirt: { color: @tshirt.color, description: @tshirt.description, neck_size: @tshirt.neck_size }
    assert_redirected_to tshirt_path(assigns(:tshirt))
  end
